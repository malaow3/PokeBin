...
function decodePokemon(pokemonPtr: number): Pokemon {
    try {
        ...
        const itemImagePtr = new Uint32Array(
            memory.buffer,
            basePtr + offset,
            1,
        );
        ...
        const pokemonImagePtr = new Uint32Array(
            memory.buffer,
            basePtr + offset,
            1,
        );
        ...
        const linesLenSlice = new Uint32Array(
            memory.buffer,
            linesLenPointer,
            1,
        );
        ...
        const lastStatEvPtr = new Uint32Array(
            memory.buffer,
            basePtr + offset,
            1,
        );
        const lastStatEvSlice = lastStatEvPtr[0];
        const last_stat_ev = decodeNullTerminatedString(
            instance,
            lastStatEvSlice,
        );
        offset += sizeOfUint32;

        const lastStatIvPtr = new Uint32Array(
            memory.buffer,
            basePtr + offset,
            1,
        );
        const lastStatIvSlice = lastStatIvPtr[0];
        const last_stat_iv = decodeNullTerminatedString(
            instance,
            lastStatIvSlice,
        );
        offset += sizeOfUint32;
        ...
        const teraTypePointer = new Uint32Array(
            memory.buffer,
            basePtr + offset,
            1,
        );
        ...
        const naturePointer = new Uint32Array(
            memory.buffer,
            basePtr + offset,
            1,
        );
